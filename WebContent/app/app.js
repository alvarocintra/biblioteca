var APP = angular.module('livroApp', ['ui.router', 'ngResource'])
  .config(function ($stateProvider) {
    ...
    }).state('deletarEmprestimo',{
    	url:'/emprestimos/delete',
    	templateUrl: 'app/view/emprestimo/delete.html',
    	controller: 'EmprestimoDeletarController'
    })  
    ...
    }).state('deletarMutuario',{
    	url: '/mutuarios/:id/deletar',
    	templateUrl: 'app/view/mutuario/delete.html',
    	controller: 'MutuarioDeletarController'
    });
  }).run(function($state) {
    $state.go('autores');
  });
